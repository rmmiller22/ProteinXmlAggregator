...
namespace Largedatabaseaggregator
{
      public static class ProteinDbLoader
    {
        ...
        internal static object LoadProteinXML(string v1, bool v2, bool v3, bool v4, bool v5, out Dictionary<string, Modification> unknownModifications)
        {
    ...
    class Program
    {
        private static object Trypsin;
        private static object ArgC;
        private static object AspN;
        private static object Chym;
        private static object GluC;
        private static object LysC;
        private static bool onTheFlyDecoys;
        private static bool IsContaminant;

        static void Main(string[] args)
        {
            Trypsin = ProteinDbLoader.LoadProteinXML(@"E:\RMM\Jurkat Pruned Multiprotease databases\Trypsin\uniprot-proteome%3AUP000005640.xml-Jurkat_SAV_DBGPTMDpruned.xml", onTheFlyDecoys, IEnumerable < Modification > allKnownModifications, IsContaminant, IEnumerable < null > modTypesToExclude, out Dictionary<string, Modification> unknownModifications);
            ArgC = ProteinDbLoader.LoadProteinXML(@"E:\RMM\Jurkat Pruned Multiprotease databases\ArgC\Jurkat_SAV_DB-uniprot-proteome%3AUP000005640.xmlGPTMDpruned.xml", onTheFlyDecoys, IEnumerable < Modification > allKnownModifications, IsContaminant, IEnumerable < null > modTypesToExclude, out Dictionary<string, Modification> unknownModifications);
            AspN = ProteinDbLoader.LoadProteinXML(@"E:\RMM\Jurkat Pruned Multiprotease databases\AspN\Jurkat_SAV_DB-uniprot-proteome%3AUP000005640.xmlGPTMDpruned.xml", onTheFlyDecoys, IEnumerable < Modification > allKnownModifications, IsContaminant, IEnumerable < null > modTypesToExclude, out Dictionary<string, Modification> unknownModifications);
            Chym = ProteinDbLoader.LoadProteinXML(@"E:\RMM\Jurkat Pruned Multiprotease databases\Chym\uniprot-proteome%3AUP000005640.xml-Jurkat_SAV_DBGPTMDpruned.xm", onTheFlyDecoys, IEnumerable < Modification > allKnownModifications, IsContaminant, IEnumerable < null > modTypesToExclude, out Dictionary<string, Modification> unknownModifications);
            GluC = ProteinDbLoader.LoadProteinXML(@"E:\RMM\Jurkat Pruned Multiprotease databases\GluC\uniprot-proteome%3AUP000005640.xml-Jurkat_SAV_DBGPTMDpruned.xml", onTheFlyDecoys, IEnumerable < Modification > allKnownModifications, IsContaminant, IEnumerable < null > modTypesToExclude, out Dictionary<string, Modification> unknownModifications);
            LysC = ProteinDbLoader.LoadProteinXML(@"E:\RMM\Jurkat Pruned Multiprotease databases\LysC\uniprot-proteome%3AUP000005640.xml-Jurkat_SAV_DBGPTMDpruned.xml", onTheFlyDecoys, IEnumerable < Modification > allKnownModifications, IsContaminant, IEnumerable < null > modTypesToExclude, out Dictionary<string, Modification> unknownModifications);
